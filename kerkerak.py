...
WEBHOOK_URL = 'https://spedpayy.onrender.com'  # ← /webhook qilib qo‘yildi
...
def callbacks(call):
    ...
    if call.data == "check_sub":
        ...
        markup.row(types.InlineKeyboardButton("LineBet UZS",callback_data="buk_LineBet"),
        types.InlineKeyboardButton("🔙 Asosiy menyu", callback_data="back_main"))
        ...
        markup.row(types.InlineKeyboardButton("LineBet UZS",callback_data="out_LineBet"),
        types.InlineKeyboardButton("🔙 Asosiy menyu", callback_data="back_main"))
